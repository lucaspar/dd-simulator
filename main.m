...
imageDatabasePathRGB='../pares/rgb';  % base image dataset (can be image files or .mat)
imageDatabasePathDepth='../pares/depth';  % base image dataset (can be image files or .mat)
%
%% Main
%
x = 42;
...
for k = 1:numSample
    for i = 1: length(baseImages)
        ...
        if loadFromMat
            ...
            distance=double(distances{i}) / 255.0;
        end
